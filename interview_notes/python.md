...
(list, dict, пользовательские объекты.
Он временно вычитает ссылки между объектами внутри графа.
Если refcount после вычитания = 0 - такой объект недостижим извне и может быть удален.
